...
const getCv = () => {
    const imageUrl = "cv_william_koszelnik_dev.pdf"
    const fileName = "cv_william_koszelnik_dev.pdf"
          ...
          <div className="flex flex-wrap">
              ...
              className="w-full lg:w-1/2 lg:p-8">
                  ...
                  <div className="flex items-center justify-center lg:justify-start">
                      <img className="rounded-2xl max-lg:w-2/3 w-2/3" src={about} alt="Image pour rubrique à propos de moi" />
                  </div>
