            ...
            {EXPERIENCES.map((experience, index) => (
                <div key={index} className="mb-8 flex flex-wrap lg:justify-center text-justify">
                    <motion.div 
                        ...
                        <p className="mb-2 text-sm text-neutral-400 max-lg:text-center">{experience.year}</p>                    
                    </motion.div>
                    <motion.div 
                        whileInView={{ opacity: 1, x: 0 }}
                        initial={{ opacity: 1, x: 100 }}
                    ...
                    >
                        <h3 className="mb-2 font-semibold max-lg:text-center">
                            {experience.role} - <span> {experience.company}</span>
                        </h3>
                        <p className="mb-4 text-neutral-400 text-justify max-lg:text-center">
